            ...
            <ul class="navbar-nav ms-auto">
                ...
                <?php else: ?>
                    <li class="nav-item dropdown">
                        <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre><i class="bi bi-person-fill"></i>
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            ...
                            <a style="color:red;" class="dropdown-item" href="<?php echo e(route('logout')); ?>"
...
<?php /**PATH C:\Users\LENOVO\Desktop\kelompok_8_modul6-master\resources\views/layouts/nav.blade.php ENDPATH**/ ?>